...
RUN cd pcl \
    ...
    -D'CMAKE_CXX_FLAGS=-fopenmp -O3 -fno-omit-frame-pointer -mno-omit-leaf-frame-pointer -fstack-protector-strong -fstack-clash-protection -Wformat -Werror=format-security -mno-outline-atomics' \
    -D'CMAKE_C_FLAGS=-fopenmp' \
    -D'CMAKE_BUILD_TYPE=Release' \
