...
void bind_spatiallocationcalculatorconfig(pybind11::module& m, void* pCallstack) {
    ...
    spatialLocationCalculatorConfig.def(py::init<>())
        ...
        .def("setCalculateSpatialKeypoints", &SpatialLocationCalculatorConfig::setCalculateSpatialKeypoints, DOC(dai, SpatialLocationCalculatorConfig, useImgDetectionKeypoints))
        ...
        .def("getCalculateSpatialKeypoints", &SpatialLocationCalculatorConfig::getCalculateSpatialKeypoints, DOC(dai, SpatialLocationCalculatorConfig, isUsingImgDetectionKeypoints))
        .def("getCalculateSpatialKeypoints", &SpatialLocationCalculatorConfig::getCalculateSpatialKeypoints, DOC(dai, SpatialLocationCalculatorConfig, isUsingImgDetectionSegmentation))
