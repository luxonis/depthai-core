...
void bind_spatiallocationcalculatorconfig(pybind11::module& m, void* pCallstack) {
    ...
    spatialLocationCalculatorConfig.def(py::init<>())
        ...
        .def_readwrite("useKeypoints", &SpatialLocationCalculatorConfig::useKeypoints)
        ...
        .def("useImgDetectionKeypoints", &SpatialLocationCalculatorConfig::useImgDetectionKeypoints, DOC(dai, SpatialLocationCalculatorConfig, useImgDetectionKeypoints))
        .def("useImgDetectionSegmentation", &SpatialLocationCalculatorConfig::useImgDetectionSegmentation, DOC(dai, SpatialLocationCalculatorConfig, useImgDetectionSegmentation))
        ...
        .def("isUsingImgDetectionKeypoints", &SpatialLocationCalculatorConfig::isUsingImgDetectionKeypoints, DOC(dai, SpatialLocationCalculatorConfig, isUsingImgDetectionKeypoints))
        .def("isUsingImgDetectionSegmentation", &SpatialLocationCalculatorConfig::isUsingImgDetectionSegmentation, DOC(dai, SpatialLocationCalculatorConfig, isUsingImgDetectionSegmentation))
