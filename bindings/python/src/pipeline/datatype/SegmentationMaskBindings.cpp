...
void bind_segmentationmask(pybind11::module& m, void* pCallstack) {
    ...
    segmentationMask.def(py::init<>())
        ...
        .def("getTimestampPtp", &SegmentationMask::getTimestampPtp, DOC(dai, Buffer, getTimestampPtp))
        ...
        .def("setTimestampPtp", &SegmentationMask::setTimestampPtp, py::arg("timestampPtp"), DOC(dai, Buffer, setTimestampPtp))
