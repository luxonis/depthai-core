...
void bind_apriltags(pybind11::module& m, void* pCallstack) {
    ...
    aprilTags.def(py::init<>())
        ...
        .def_property(
            "aprilTags", [](AprilTags& det) { return &det.aprilTags; }, [](AprilTags& det, std::vector<AprilTag> val) { det.aprilTags = val; })
        ...
        .def("setTransformation",
             [](AprilTags& msg, const std::optional<ImgTransformation>& transformation) { msg.transformation = transformation; })
