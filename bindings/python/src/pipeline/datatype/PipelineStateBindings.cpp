...
void bind_pipelinestate(pybind11::module& m, void* pCallstack) {
    ...
    pipelineState.def(py::init<>())
        ...
        .def("getTimestampPtp", &PipelineState::Buffer::getTimestampPtp, DOC(dai, Buffer, getTimestampPtp))
        ...
        .def("setTimestampPtp", &PipelineState::setTimestampPtp, DOC(dai, Buffer, setTimestampPtp))
