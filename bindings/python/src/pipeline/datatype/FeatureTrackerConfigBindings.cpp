...
void bind_featuretrackerconfig(pybind11::module& m, void* pCallstack) {
    ...
    // py::class_<RawFeatureTrackerConfig, RawBuffer, std::shared_ptr<RawFeatureTrackerConfig>> rawFeatureTrackerConfig(m, "RawFeatureTrackerConfig", DOC(dai,
    // RawFeatureTrackerConfig));
    py::class_<FeatureTrackerConfig, Py<FeatureTrackerConfig>, Buffer, std::shared_ptr<FeatureTrackerConfig>> featureTrackerConfig(
        m, "FeatureTrackerConfig", DOC(dai, FeatureTrackerConfig));
    ...
    py::class_<FeatureTrackerConfig::CornerDetector::Thresholds> cornerDetectorThresholds(
        cornerDetector, "Thresholds", DOC(dai, FeatureTrackerConfig, CornerDetector, Thresholds));
    ...
    py::class_<FeatureTrackerConfig::MotionEstimator::OpticalFlow> motionEstimatorOpticalFlow(
        motionEstimator, "OpticalFlow", DOC(dai, FeatureTrackerConfig, MotionEstimator, OpticalFlow));
    py::class_<FeatureTrackerConfig::FeatureMaintainer> featureMaintainer(
        featureTrackerConfig, "FeatureMaintainer", DOC(dai, FeatureTrackerConfig, FeatureMaintainer));
    ...
    cornerDetectorType.value("HARRIS", FeatureTrackerConfig::CornerDetector::Type::HARRIS)
        .value("SHI_THOMASI", FeatureTrackerConfig::CornerDetector::Type::SHI_THOMASI);

    cornerDetectorThresholds.def(py::init<>())
        .def_readwrite("initialValue",
                       &FeatureTrackerConfig::CornerDetector::Thresholds::initialValue,
                       DOC(dai, FeatureTrackerConfig, CornerDetector, Thresholds, initialValue))
        ...
        .def_readwrite("decreaseFactor",
                       &FeatureTrackerConfig::CornerDetector::Thresholds::decreaseFactor,
                       DOC(dai, FeatureTrackerConfig, CornerDetector, Thresholds, decreaseFactor))
        .def_readwrite("increaseFactor",
                       &FeatureTrackerConfig::CornerDetector::Thresholds::increaseFactor,
                       DOC(dai, FeatureTrackerConfig, CornerDetector, Thresholds, increaseFactor));

    cornerDetector.def(py::init<>())
        .def_readwrite("type", &FeatureTrackerConfig::CornerDetector::type, DOC(dai, FeatureTrackerConfig, CornerDetector, type))
        .def_readwrite(
            "cellGridDimension", &FeatureTrackerConfig::CornerDetector::cellGridDimension, DOC(dai, FeatureTrackerConfig, CornerDetector, cellGridDimension))
        .def_readwrite(
            "numTargetFeatures", &FeatureTrackerConfig::CornerDetector::numTargetFeatures, DOC(dai, FeatureTrackerConfig, CornerDetector, numTargetFeatures))
    ...
    motionEstimatorType.value("LUCAS_KANADE_OPTICAL_FLOW", FeatureTrackerConfig::MotionEstimator::Type::LUCAS_KANADE_OPTICAL_FLOW)
        .value("HW_MOTION_ESTIMATION", FeatureTrackerConfig::MotionEstimator::Type::HW_MOTION_ESTIMATION);

    motionEstimatorOpticalFlow.def(py::init<>())
        .def_readwrite("pyramidLevels",
                       &FeatureTrackerConfig::MotionEstimator::OpticalFlow::pyramidLevels,
                       DOC(dai, FeatureTrackerConfig, MotionEstimator, OpticalFlow, pyramidLevels))
        .def_readwrite("searchWindowWidth",
                       &FeatureTrackerConfig::MotionEstimator::OpticalFlow::searchWindowWidth,
                       DOC(dai, FeatureTrackerConfig, MotionEstimator, OpticalFlow, searchWindowWidth))
        .def_readwrite("searchWindowHeight",
                       &FeatureTrackerConfig::MotionEstimator::OpticalFlow::searchWindowHeight,
                       DOC(dai, FeatureTrackerConfig, MotionEstimator, OpticalFlow, searchWindowHeight))
        .def_readwrite(
            "epsilon", &FeatureTrackerConfig::MotionEstimator::OpticalFlow::epsilon, DOC(dai, FeatureTrackerConfig, MotionEstimator, OpticalFlow, epsilon))
        .def_readwrite("maxIterations",
                       &FeatureTrackerConfig::MotionEstimator::OpticalFlow::maxIterations,
                       DOC(dai, FeatureTrackerConfig, MotionEstimator, OpticalFlow, maxIterations));

    motionEstimator.def(py::init<>())
    ...
    featureMaintainer.def(py::init<>())
        .def_readwrite("enable", &FeatureTrackerConfig::FeatureMaintainer::enable, DOC(dai, FeatureTrackerConfig, FeatureMaintainer, enable))
        .def_readwrite("minimumDistanceBetweenFeatures",
                       &FeatureTrackerConfig::FeatureMaintainer::minimumDistanceBetweenFeatures,
                       DOC(dai, FeatureTrackerConfig, FeatureMaintainer, minimumDistanceBetweenFeatures))
        .def_readwrite("lostFeatureErrorThreshold",
                       &FeatureTrackerConfig::FeatureMaintainer::lostFeatureErrorThreshold,
                       DOC(dai, FeatureTrackerConfig, FeatureMaintainer, lostFeatureErrorThreshold))
        .def_readwrite("trackedFeatureThreshold",
                       &FeatureTrackerConfig::FeatureMaintainer::trackedFeatureThreshold,
    ...
    featureTrackerConfig.def(py::init<>())
        ...
        .def("setCornerDetector",
             static_cast<FeatureTrackerConfig& (FeatureTrackerConfig::*)(dai::FeatureTrackerConfig::CornerDetector::Type)>(
                 &FeatureTrackerConfig::setCornerDetector),
             py::arg("cornerDetector"),
             DOC(dai, FeatureTrackerConfig, setCornerDetector))
        .def("setCornerDetector",
             static_cast<FeatureTrackerConfig& (FeatureTrackerConfig::*)(const dai::FeatureTrackerConfig::CornerDetector&)>(
                 &FeatureTrackerConfig::setCornerDetector),
             py::arg("config"),
             DOC(dai, FeatureTrackerConfig, setCornerDetector, 2))
        .def("setMotionEstimator",
             static_cast<FeatureTrackerConfig& (FeatureTrackerConfig::*)(bool)>(&FeatureTrackerConfig::setMotionEstimator),
             py::arg("enable"),
             DOC(dai, FeatureTrackerConfig, setMotionEstimator))
        .def("setMotionEstimator",
             static_cast<FeatureTrackerConfig& (FeatureTrackerConfig::*)(const dai::FeatureTrackerConfig::MotionEstimator&)>(
                 &FeatureTrackerConfig::setMotionEstimator),
             py::arg("config"),
        ...
        .def("setFeatureMaintainer",
             static_cast<FeatureTrackerConfig& (FeatureTrackerConfig::*)(bool)>(&FeatureTrackerConfig::setFeatureMaintainer),
             py::arg("enable"),
             DOC(dai, FeatureTrackerConfig, setFeatureMaintainer))
        .def("setFeatureMaintainer",
             static_cast<FeatureTrackerConfig& (FeatureTrackerConfig::*)(dai::FeatureTrackerConfig::FeatureMaintainer)>(
                 &FeatureTrackerConfig::setFeatureMaintainer),
             py::arg("config"),
             DOC(dai, FeatureTrackerConfig, setFeatureMaintainer, 2))
        .def("setNumTargetFeatures",
             &FeatureTrackerConfig::setNumTargetFeatures,
             py::arg("numTargetFeatures"),
             DOC(dai, FeatureTrackerConfig, setNumTargetFeatures))
