...
void bind_basaltnode(pybind11::module& m, void* pCallstack) {
    ...
    basaltNode.def_property_readonly(
        ...
        .def("setAccelNoiseStd", &BasaltVIO::setAccelNoiseStd, py::arg("noise"), DOC(dai, node, BasaltVIO, setAccelNoise))
        .def("setGyroNoiseStd", &BasaltVIO::setGyroNoiseStd, py::arg("noise"), DOC(dai, node, BasaltVIO, setGyroNoise))
