    ...
    spatialDetectionNetwork
        ...
        .def("build",
             py::overload_cast<const std::shared_ptr<Camera>&,
                               const std::shared_ptr<StereoDepth>&,
                               NNModelDescription,
                               std::optional<float>,
                               std::optional<dai::ImgResizeMode>>(&SpatialDetectionNetwork::build),
             py::arg("input"),
             py::arg("stereo"),
             py::arg("model"),
        ...
        .def("build",
             ([](SpatialDetectionNetwork& self,
                 ...
                 std::optional<dai::ImgResizeMode> resizeMode) { return self.build(input, stereo, NNModelDescription{model}, fps, resizeMode); }),
             py::arg("input"),
             py::arg("stereo"),
             py::arg("model"),
             py::arg("fps") = std::nullopt,
        ...
        .def("build",
             py::overload_cast<const std::shared_ptr<Camera>&,
                               const std::shared_ptr<NeuralDepth>&,
                               NNModelDescription,
                               std::optional<float>,
                               std::optional<dai::ImgResizeMode>>(&SpatialDetectionNetwork::build),
             py::arg("input"),
        ...
        .def("build",
             ([](SpatialDetectionNetwork& self,
                 ...
                 std::string model,
                 std::optional<float> fps,
                 std::optional<dai::ImgResizeMode> resizeMode) { return self.build(input, neuralDepth, NNModelDescription{model}, fps, resizeMode); }),
             py::arg("input"),
             py::arg("neuralDepth"),
             py::arg("model"),
             py::arg("fps") = std::nullopt,
        ...
        .def("build",
             ...
             py::arg("fps") = std::nullopt,
             py::arg_v("resizeMode", dai::ImgResizeMode::CROP, "dai.ImgResizeMode.CROP"),
             DOC(dai, node, SpatialDetectionNetwork, build, 5))
        .def("build",
             py::overload_cast<const std::shared_ptr<Camera>&,
                               const std::shared_ptr<ToF>&,
                               NNModelDescription,
                               std::optional<float>,
                               std::optional<dai::ImgResizeMode>>(&SpatialDetectionNetwork::build),
             py::arg("input"),
             ...
             py::arg("fps") = std::nullopt,
             py::arg_v("resizeMode", dai::ImgResizeMode::CROP, "dai.ImgResizeMode.CROP"),
             DOC(dai, node, SpatialDetectionNetwork, build, 6))
        .def("build",
             ([](SpatialDetectionNetwork& self,
                 const std::shared_ptr<Camera>& input,
                 ...
                 std::string model,
                 std::optional<float> fps,
                 std::optional<dai::ImgResizeMode> resizeMode) { return self.build(input, tof, NNModelDescription{model}, fps, resizeMode); }),
             py::arg("input"),
             py::arg("tof"),
             py::arg("model"),
             py::arg("fps") = std::nullopt,
             py::arg_v("resizeMode", dai::ImgResizeMode::CROP, "dai.ImgResizeMode.CROP"),
             DOC(dai, node, SpatialDetectionNetwork, build, 7))
        .def("build",
             py::overload_cast<const std::shared_ptr<Camera>&,
                               const std::shared_ptr<ToF>&,
                               const NNArchive&,
             ...
             py::arg("fps") = std::nullopt,
             py::arg_v("resizeMode", dai::ImgResizeMode::CROP, "dai.ImgResizeMode.CROP"),
             DOC(dai, node, SpatialDetectionNetwork, build, 8))
