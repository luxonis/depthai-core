...
void NodeBindings::addToCallstack(std::deque<StackFunction>& callstack) {
    ...
    callstack.push_front(bind_spatialdetectioncalculator);
    callstack.push_front(bind_overlay);
    callstack.push_front(bind_spatialkeypointscalculator);
    ...
    callstack.push_front(bind_yolosegmentationparser);
