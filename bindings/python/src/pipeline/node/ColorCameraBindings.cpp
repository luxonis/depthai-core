...
void bind_colorcamera(pybind11::module& m, void* pCallstack) {
    ...
    py::enum_<ColorCameraProperties::ColorOrder> colorCameraPropertiesColorOrder(
        colorCameraProperties, "ColorOrder", DOC(dai, ColorCameraProperties, ColorOrder));
    py::enum_<ColorCameraProperties::WarpMeshSource> colorCameraPropertiesWarpMeshSource(
        colorCameraProperties, "WarpMeshSource", DOC(dai, ColorCameraProperties, WarpMeshSource));
    ...
    colorCameraPropertiesSensorResolution.value("THE_1080_P", ColorCameraProperties::SensorResolution::THE_1080_P)
    ...
    colorCameraPropertiesColorOrder.value("BGR", ColorCameraProperties::ColorOrder::BGR).value("RGB", ColorCameraProperties::ColorOrder::RGB);

    colorCameraPropertiesWarpMeshSource.value("AUTO", ColorCameraProperties::WarpMeshSource::AUTO)
    ...
    colorCamera
        ...
        .def("setPreviewSize",
             static_cast<void (ColorCamera::*)(int, int)>(&ColorCamera::setPreviewSize),
             py::arg("width"),
             py::arg("height"),
        ...
        .def("setVideoSize",
             static_cast<void (ColorCamera::*)(int, int)>(&ColorCamera::setVideoSize),
             py::arg("width"),
             py::arg("height"),
        ...
        .def("setStillSize",
             static_cast<void (ColorCamera::*)(int, int)>(&ColorCamera::setStillSize),
             py::arg("width"),
             py::arg("height"),
        ...
        .def("setIspScale",
             static_cast<void (ColorCamera::*)(int, int)>(&ColorCamera::setIspScale),
             py::arg("numerator"),
             py::arg("denominator"),
        ...
        .def("setIspScale",
             static_cast<void (ColorCamera::*)(int, int, int, int)>(&ColorCamera::setIspScale),
             py::arg("horizNum"),
             py::arg("horizDenom"),
             py::arg("vertNum"),
             py::arg("vertDenom"),
        ...
        .def("setNumFramesPool",
             &ColorCamera::setNumFramesPool,
             py::arg("raw"),
             py::arg("isp"),
             py::arg("preview"),
             py::arg("video"),
             py::arg("still"),
             DOC(dai, node, ColorCamera, setNumFramesPool))
