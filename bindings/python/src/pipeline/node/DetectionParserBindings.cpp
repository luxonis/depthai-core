...
void bind_detectionparser(pybind11::module& m, void* pCallstack){
    ...
    detectionParser
        ...
        .def("setNNArchive", py::overload_cast<const NNArchive&>(&DetectionParser::setNNArchive), py::arg("nnArchive"), DOC(dai, node, DetectionParser, setNNArchive))
        .def("setNNArchive", py::overload_cast<const NNArchive&, int>(&DetectionParser::setNNArchive), py::arg("nnArchive"), py::arg("numShaves"), DOC(dai, node, DetectionParser, setNNArchive, 2))
        .def("setFromModelzoo", py::overload_cast<NNModelDescription, bool>(&DetectionParser::setFromModelzoo), py::arg("description"), py::arg("useCached"), DOC(dai, node, DetectionParser, setFromModelzoo))
        .def("setFromModelzoo", py::overload_cast<NNModelDescription, int, bool>(&DetectionParser::setFromModelzoo), py::arg("description"), py::arg("numShaves"), py::arg("useCached"), DOC(dai, node, DetectionParser, setFromModelzoo, 2))
