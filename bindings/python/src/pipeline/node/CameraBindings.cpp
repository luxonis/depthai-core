...
void bind_camera(pybind11::module& m, void* pCallstack) {
    ...
    camera.def_readonly("inputControl", &Camera::inputControl, DOC(dai, node, Camera, inputControl))
        ...
        .def("setPreviewNumFramesPool", &Camera::setPreviewNumFramesPool, "num"_a, DOC(dai, node, Camera, setPreviewNumFramesPool))
        .def("setMaxSizePoolPreview", &Camera::setMaxSizePoolPreview, "size"_a, DOC(dai, node, Camera, setMaxSizePoolPreview))
        .def("setVideoNumFramesPool", &Camera::setVideoNumFramesPool, "num"_a, DOC(dai, node, Camera, setVideoNumFramesPool))
        .def("setMaxSizePoolVideo", &Camera::setMaxSizePoolVideo, "size"_a, DOC(dai, node, Camera, setMaxSizePoolVideo))
        .def("setStillNumFramesPool", &Camera::setStillNumFramesPool, "num"_a, DOC(dai, node, Camera, setStillNumFramesPool))
        .def("setMaxSizePoolStill", &Camera::setMaxSizePoolStill, "size"_a, DOC(dai, node, Camera, setMaxSizePoolStill))
        .def("setNumFramesPools", &Camera::setNumFramesPools, "raw"_a, "isp"_a, "preview"_a, "video"_a, "still"_a, DOC(dai, node, Camera, setNumFramesPools))
        .def("setMaxSizePools", &Camera::setMaxSizePools, "raw"_a, "isp"_a, "preview"_a, "video"_a, "still"_a, DOC(dai, node, Camera, setMaxSizePools))
        ...
        .def("getMaxSizePoolPreview", &Camera::getMaxSizePoolPreview, DOC(dai, node, Camera, getMaxSizePoolPreview))
        .def("getVideoNumFramesPool", &Camera::getVideoNumFramesPool, DOC(dai, node, Camera, getVideoNumFramesPool))
        .def("getMaxSizePoolVideo", &Camera::getMaxSizePoolVideo, DOC(dai, node, Camera, getMaxSizePoolVideo))
        .def("getStillNumFramesPool", &Camera::getStillNumFramesPool, DOC(dai, node, Camera, getStillNumFramesPool))
        .def("getMaxSizePoolStill", &Camera::getMaxSizePoolStill, DOC(dai, node, Camera, getMaxSizePoolStill))
