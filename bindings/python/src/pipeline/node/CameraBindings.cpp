...
void bind_camera(pybind11::module& m, void* pCallstack) {
    ...
    camera.def_readonly("inputControl", &Camera::inputControl, DOC(dai, node, Camera, inputControl))
        ...
        .def("setOutputsImageManipNumFramesPool", &Camera::setOutputsImageManipNumFramesPool, "num"_a, DOC(dai, node, Camera, setOutputsImageManipNumFramesPool))
        .def("setOutputsImageManipMaxSizePool", &Camera::setOutputsImageManipMaxSizePool, "size"_a, DOC(dai, node, Camera, setOutputsImageManipMaxSizePool))
        ...
        .def("getOutputsImageManipNumFramesPool", &Camera::getOutputsImageManipNumFramesPool, DOC(dai, node, Camera, getOutputsImageManipNumFramesPool))
        .def("getOutputsImageManipMaxSizePool", &Camera::getOutputsImageManipMaxSizePool, DOC(dai, node, Camera, getOutputsImageManipMaxSizePool))
