...
int main() {
    ...
    const std::string modelSlug = "luxonis/lite-hrnet:18-coco-288x384";
    ...
    auto parserNode = pipeline.create<dai::beta::node::HRNetParser>()->build(neuralNetwork->out, modelArchive);
