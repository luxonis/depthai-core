...
int main() {
    ...
    const std::string modelSlug = "luxonis/scrfd-face-detection:10g-640x640";
    ...
    auto parserNode = pipeline.create<dai::beta::node::SCRFDParser>()->build(neuralNetwork->out, modelArchive);
