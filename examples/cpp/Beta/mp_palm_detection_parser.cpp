...
int main() {
    ...
    const std::string modelSlug = "luxonis/mediapipe-palm-detection:192x192";
    ...
    auto parserNode = pipeline.create<dai::beta::node::MPPalmDetectionParser>()->build(neuralNetwork->out, modelArchive);
    ...
    while(pipeline.isRunning()) {
        ...
        cv::imshow("MPPalmDetectionParser", frame);
