...
int main() {
    ...
    while(pipeline.isRunning()) {
        ...
        dynCalibInputControl->send(std::make_shared<DCC>(DCC::CalibrationQualityCommand{false}));
        ...
        if(dynCalibrationResult) {
            ...
            if(dynCalibrationResult->qualityData) {
                ...
                // dynCalibInputControl->send(std::make_shared<DCC>(DCC::CalibrateCommand{/*force=*/true}));
