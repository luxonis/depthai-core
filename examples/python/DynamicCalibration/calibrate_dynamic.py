...
with dai.Pipeline() as pipeline:
    ...
    dynCalibInputControl.send(
        dai.DynamicCalibrationControl(dai.StartCalibrationCommand())
    )
        ...
        if calibrationData:
            ...
            dynCalibInputControl.send(
                dai.DynamicCalibrationControl(
                    dai.ApplyCalibrationCommand(calibrationData.newCalibration)
                )
            )
            ...
            dynCalibInputControl.send(
                dai.DynamicCalibrationControl(dai.ResetDataCommand())
            )
            dynCalibInputControl.send(
                dai.DynamicCalibrationControl(dai.StartCalibrationCommand())
            )
