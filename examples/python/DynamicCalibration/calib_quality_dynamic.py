...
with dai.Pipeline() as pipeline:
    ...
    while pipeline.isRunning():
        ...
        dynCalibInputControl.send(dai.DynamicCalibrationControl(dai.LoadImageCommand()))
        ...
        dynCalibInputControl.send(dai.DynamicCalibrationControl(dai.CalibrationQualityCommand(False)))
        ...
        if dynQualityResult is not None:
            ...
            if dynQualityResult.qualityData:
                ...
                dynCalibInputControl.send(dai.DynamicCalibrationControl(dai.ResetDataCommand()))
