...
with dai.Pipeline() as p:
    ...
    camRgb = p.create(dai.node.Camera).build(dai.CameraBoardSocket.CAM_B)
    tof = p.create(dai.node.ToF).build(dai.CameraBoardSocket.CAM_A, fps=FPS)
    spatialDetectionNetwork = p.create(dai.node.SpatialDetectionNetwork).build(camRgb, tof, modelDescription, fps=FPS)
