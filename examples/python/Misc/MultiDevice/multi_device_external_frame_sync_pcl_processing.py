...
# This example also calculates the point cloud. Visualisation of point cloud is not implemented.
...
#   python multi_device_external_frame_sync.py [-f <FPS>] [-nn]
# This will pick up all connected devices.
# Use -nn to run depth on device neural processpr instead of host based classical stereo
...
def setupDevice(
    ...
    # Its output is used to calculate the point cloud
