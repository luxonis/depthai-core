...
def setupDevice(
        ...
        targetFps: float):
    global masterPipeline, slavePipelines, slaveQueues, camSockets, slaveOnly, firstSlaveName
...
with contextlib.ExitStack() as stack:
    ...
    if not slaveOnly:
        ...
        benchmarkAll = slavePipelines[firstSlaveName].create(dai.node.BenchmarkIn)
