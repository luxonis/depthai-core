...
cam_left.requestOutput(RESOLUTION, type=dai.ImgFrame.Type.GRAY8, fps=FPS).link(gpu.left)
cam_right.requestOutput(RESOLUTION, type=dai.ImgFrame.Type.GRAY8, fps=FPS).link(gpu.right)
