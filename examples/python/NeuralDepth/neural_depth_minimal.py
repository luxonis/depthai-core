...
with dai.Pipeline() as pipeline:
    ...
    neuralDepth = pipeline.create(dai.node.NeuralDepth).build(dai.DeviceModelZoo.NEURAL_DEPTH_LARGE)
    leftOutput.link(neuralDepth.left)
    rightOutput.link(neuralDepth.right)
