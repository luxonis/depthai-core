 ...
 *   P3  <-  P2
 */
static constexpr dai::Point2f P0 = {0, 0};  // top-left
static constexpr dai::Point2f P1 = {1, 0};  // top-right
static constexpr dai::Point2f P2 = {1, 1};  // bottom-right
static constexpr dai::Point2f P3 = {0, 1};  // bottom-left
