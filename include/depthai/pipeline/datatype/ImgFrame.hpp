...
class ImgFrame : public Buffer {
   ...
   public:
    ...
    /**
     * Retrieves lens position, range 0.0f..1.0f. Returns -1.0f if not available.
     */
     ...
     * Sets lensPosition,
     */
    ImgFrame& setLensPosition(int lensPosition);

    /**
     * Sets lensPositionRaw
     */
    ImgFrame& setLensPositionRaw(float lensPositionRaw);
