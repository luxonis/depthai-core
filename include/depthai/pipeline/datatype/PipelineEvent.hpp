...
class PipelineEvent : public Buffer {
   public:
    ...
    DEPTHAI_SERIALIZE(PipelineEvent, Buffer::ts, Buffer::tsDevice, Buffer::tsSystem, Buffer::tsPtp, Buffer::sequenceNum, nodeId, status, queueSize, interval, type, source);
    #else
