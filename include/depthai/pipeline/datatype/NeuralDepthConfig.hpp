...
class NeuralDepthConfig : public Buffer {
   public:
     ...
     */
    NeuralDepthConfig& setDepthAlign(AlgorithmControl::DepthAlign align);

    /**
     * Confidence threshold for disparity calculation
     * @param confThr Confidence threshold value 0..255
     */
    NeuralDepthConfig& setConfidenceThreshold(int confThr);
    /**
     ...
     */
    NeuralDepthConfig& setMedianFilter(MedianFilter median);
    /**
     ...
     */
    NeuralDepthConfig& setBilateralFilterSigma(uint16_t sigma);
    /**
     ...
     */
    NeuralDepthConfig& setLeftRightCheckThreshold(int threshold);
    /**
     ...
     */
    NeuralDepthConfig& setLeftRightCheck(bool enable);
     ...
     * Suitable for short range objects
     */
    NeuralDepthConfig& setExtendedDisparity(bool enable);
     ...
     */
    NeuralDepthConfig& setSubpixel(bool enable);
     ...
     * Median filter postprocessing is supported only for 3 fractional bits.
     */
    NeuralDepthConfig& setSubpixelFractionalBits(int subpixelFractionalBits);
     ...
     * pointing down at the table surface.
     */
    NeuralDepthConfig& setDisparityShift(int disparityShift);
     ...
     * for left alignment from the left edge.
     */
    NeuralDepthConfig& setNumInvalidateEdgePixels(int32_t numInvalidateEdgePixels);

    /**
     * Set filters compute backend
     */
    NeuralDepthConfig& setFiltersComputeBackend(dai::ProcessorType filtersBackend);
    ...
    DEPTHAI_SERIALIZE(NeuralDepthConfig, algorithmControl, postProcessing, censusTransform, costMatching, costAggregation, confidenceMetrics, filtersBackend);
};
