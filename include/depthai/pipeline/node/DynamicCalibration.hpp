...
class DynamicCalibration : public DeviceNodeCRTP<DeviceNode, DynamicCalibration, DynamicCalibrationProperties>, public HostRunnable {
   ...
   public:
    ...
    ErrorCode runCalibration(const CalibrationHandler& currentCalib, const bool force = false);
   ...
   private:
     ...
     * DAI held properties
     */
    std::shared_ptr<CalibrationHandler> newCalibrationHandler;
    std::shared_ptr<CalibrationHandler> calibrationHandler;
    std::shared_ptr<CalibrationHandler> previousCalibrationHandler;
    std::shared_ptr<CalibrationHandler> initialCalibrationHandler;
