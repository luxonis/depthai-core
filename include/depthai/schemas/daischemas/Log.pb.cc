    ...
    ::_pbi::ConstantInitialized) noexcept
      : _cached_size_{0},
        ...
        file_(
            ...
            ::_pbi::ConstantInitialized()),
        timestamp_{nullptr},
        level_{static_cast< ::dai::schemas::Log_Level >(0)},
        line_{0u} {}
...
static ::_pb::Metadata file_level_metadata_daischemas_2fLog_2eproto[1];
static const ::_pb::EnumDescriptor* file_level_enum_descriptors_daischemas_2fLog_2eproto[1];
static constexpr const ::_pb::ServiceDescriptor**
    file_level_service_descriptors_daischemas_2fLog_2eproto = nullptr;
const ::uint32_t TableStruct_daischemas_2fLog_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
    protodesc_cold) = {
    PROTOBUF_FIELD_OFFSET(::dai::schemas::Log, _impl_._has_bits_),
    PROTOBUF_FIELD_OFFSET(::dai::schemas::Log, _internal_metadata_),
    ~0u,  // no _extensions_
    ~0u,  // no _oneof_case_
    ...
    ~0u,  // no _split_
    ~0u,  // no sizeof(Split)
    PROTOBUF_FIELD_OFFSET(::dai::schemas::Log, _impl_.timestamp_),
    PROTOBUF_FIELD_OFFSET(::dai::schemas::Log, _impl_.level_),
    PROTOBUF_FIELD_OFFSET(::dai::schemas::Log, _impl_.message_),
    PROTOBUF_FIELD_OFFSET(::dai::schemas::Log, _impl_.name_),
    PROTOBUF_FIELD_OFFSET(::dai::schemas::Log, _impl_.file_),
    PROTOBUF_FIELD_OFFSET(::dai::schemas::Log, _impl_.line_),
    0,
    ~0u,
    ~0u,
    ~0u,
...
static const ::_pbi::MigrationSchema
    schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
        {0, 14, -1, sizeof(::dai::schemas::Log)},
};

static const ::_pb::Message* const file_default_instances[] = {
    &::dai::schemas::_Log_default_instance_._instance,
};
const char descriptor_table_protodef_daischemas_2fLog_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
    "\n\024daischemas/Log.proto\022\013dai.schemas\032\037goo"
    "gle/protobuf/timestamp.proto\"\344\001\n\003Log\022-\n\t"
    "timestamp\030\001 \001(\0132\032.google.protobuf.Timest"
    "amp\022%\n\005level\030\002 \001(\0162\026.dai.schemas.Log.Lev"
...
static const ::_pbi::DescriptorTable* const descriptor_table_daischemas_2fLog_2eproto_deps[1] =
    {
        &::descriptor_table_google_2fprotobuf_2ftimestamp_2eproto,
};
static ::absl::once_flag descriptor_table_daischemas_2fLog_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_daischemas_2fLog_2eproto = {
    false,
    false,
    307,
    descriptor_table_protodef_daischemas_2fLog_2eproto,
    "daischemas/Log.proto",
    &descriptor_table_daischemas_2fLog_2eproto_once,
    descriptor_table_daischemas_2fLog_2eproto_deps,
    1,
    1,
    schemas,
    file_default_instances,
    TableStruct_daischemas_2fLog_2eproto::offsets,
    file_level_metadata_daischemas_2fLog_2eproto,
    file_level_enum_descriptors_daischemas_2fLog_2eproto,
    file_level_service_descriptors_daischemas_2fLog_2eproto,
};
...
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_daischemas_2fLog_2eproto_getter() {
  return &descriptor_table_daischemas_2fLog_2eproto;
}
// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2
static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_daischemas_2fLog_2eproto(&descriptor_table_daischemas_2fLog_2eproto);
namespace dai {
namespace schemas {
const ::google::protobuf::EnumDescriptor* Log_Level_descriptor() {
  ::google::protobuf::internal::AssignDescriptors(&descriptor_table_daischemas_2fLog_2eproto);
  return file_level_enum_descriptors_daischemas_2fLog_2eproto[0];
}
...
Log::Log(::google::protobuf::Arena* arena)
  ...
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:dai.schemas.Log)
}
...
Log::Log(
  ...
  // @@protoc_insertion_point(copy_constructor:dai.schemas.Log)
}
inline PROTOBUF_NDEBUG_INLINE Log::Impl_::Impl_(
...
Log::~Log() {
  // @@protoc_insertion_point(destructor:dai.schemas.Log)
...
// @@protoc_insertion_point(message_clear_start:dai.schemas.Log)
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
...
const ::_pbi::TcParseTable<3, 6, 1, 39, 2> Log::_table_ = {
  {
...
::uint8_t* Log::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:dai.schemas.Log)
  ::uint32_t cached_has_bits = 0;
  (void)cached_has_bits;
  ...
  if (!this->_internal_message().empty()) {
    ...
    ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "dai.schemas.Log.message");
  ...
  if (!this->_internal_name().empty()) {
    ...
    ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "dai.schemas.Log.name");
  ...
  if (!this->_internal_file().empty()) {
    ...
    ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "dai.schemas.Log.file");
  ...
  // @@protoc_insertion_point(serialize_to_array_end:dai.schemas.Log)
  return target;
}

::size_t Log::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:dai.schemas.Log)
  ::size_t total_size = 0;
...
void Log::MergeImpl(::google::protobuf::Message& to_msg, const ::google::protobuf::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:dai.schemas.Log)
...
// @@protoc_insertion_point(class_specific_copy_from_start:dai.schemas.Log)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
::google::protobuf::Metadata Log::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_daischemas_2fLog_2eproto_getter, &descriptor_table_daischemas_2fLog_2eproto_once,
      file_level_metadata_daischemas_2fLog_2eproto[0]);
}
