...
#ifndef GOOGLE_PROTOBUF_INCLUDED_daischemas_2fColor_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_daischemas_2fColor_2eproto_2epb_2eh
...
#define PROTOBUF_INTERNAL_EXPORT_daischemas_2fColor_2eproto
...
struct TableStruct_daischemas_2fColor_2eproto {
...
class Color final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:dai.schemas.Color) */ {
 public:
  ...
  public:
  // @@protoc_insertion_point(class_scope:dai.schemas.Color)
 private:
  class _Internal;
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_daischemas_2fColor_2eproto;
};
...
inline double Color::r() const {
  // @@protoc_insertion_point(field_get:dai.schemas.Color.r)
  return _internal_r();
}
inline void Color::set_r(double value) {
  _internal_set_r(value);
  // @@protoc_insertion_point(field_set:dai.schemas.Color.r)
}
...
inline double Color::g() const {
  // @@protoc_insertion_point(field_get:dai.schemas.Color.g)
  return _internal_g();
}
inline void Color::set_g(double value) {
  _internal_set_g(value);
  // @@protoc_insertion_point(field_set:dai.schemas.Color.g)
}
...
inline double Color::b() const {
  // @@protoc_insertion_point(field_get:dai.schemas.Color.b)
  return _internal_b();
}
inline void Color::set_b(double value) {
  _internal_set_b(value);
  // @@protoc_insertion_point(field_set:dai.schemas.Color.b)
}
...
inline double Color::a() const {
  // @@protoc_insertion_point(field_get:dai.schemas.Color.a)
  return _internal_a();
}
inline void Color::set_a(double value) {
  _internal_set_a(value);
  // @@protoc_insertion_point(field_set:dai.schemas.Color.a)
}
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_daischemas_2fColor_2eproto_2epb_2eh
