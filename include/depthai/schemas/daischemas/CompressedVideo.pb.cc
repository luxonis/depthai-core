...
#include "daischemas/CompressedVideo.pb.h"
...
static ::_pb::Metadata file_level_metadata_daischemas_2fCompressedVideo_2eproto[1];
static constexpr const ::_pb::EnumDescriptor**
    file_level_enum_descriptors_daischemas_2fCompressedVideo_2eproto = nullptr;
static constexpr const ::_pb::ServiceDescriptor**
    file_level_service_descriptors_daischemas_2fCompressedVideo_2eproto = nullptr;
const ::uint32_t TableStruct_daischemas_2fCompressedVideo_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
    protodesc_cold) = {
    PROTOBUF_FIELD_OFFSET(::dai::schemas::CompressedVideo, _impl_._has_bits_),
    PROTOBUF_FIELD_OFFSET(::dai::schemas::CompressedVideo, _internal_metadata_),
    ~0u,  // no _extensions_
    ~0u,  // no _oneof_case_
    ...
    ~0u,  // no _split_
    ~0u,  // no sizeof(Split)
    PROTOBUF_FIELD_OFFSET(::dai::schemas::CompressedVideo, _impl_.timestamp_),
    PROTOBUF_FIELD_OFFSET(::dai::schemas::CompressedVideo, _impl_.frame_id_),
    PROTOBUF_FIELD_OFFSET(::dai::schemas::CompressedVideo, _impl_.data_),
    PROTOBUF_FIELD_OFFSET(::dai::schemas::CompressedVideo, _impl_.format_),
    0,
    ~0u,
    ~0u,
    ~0u,
...
static const ::_pbi::MigrationSchema
    schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
        {0, 12, -1, sizeof(::dai::schemas::CompressedVideo)},
};

static const ::_pb::Message* const file_default_instances[] = {
    &::dai::schemas::_CompressedVideo_default_instance_._instance,
};
const char descriptor_table_protodef_daischemas_2fCompressedVideo_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
    "\n daischemas/CompressedVideo.proto\022\013dai."
    ...
    " \001(\t\022\014\n\004data\030\003 \001(\014\022\016\n\006format\030\004 \001(\tb\006prot"
    "o3"
};
static const ::_pbi::DescriptorTable* const descriptor_table_daischemas_2fCompressedVideo_2eproto_deps[1] =
    {
        &::descriptor_table_google_2fprotobuf_2ftimestamp_2eproto,
};
static ::absl::once_flag descriptor_table_daischemas_2fCompressedVideo_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_daischemas_2fCompressedVideo_2eproto = {
    false,
    false,
    202,
    descriptor_table_protodef_daischemas_2fCompressedVideo_2eproto,
    "daischemas/CompressedVideo.proto",
    &descriptor_table_daischemas_2fCompressedVideo_2eproto_once,
    descriptor_table_daischemas_2fCompressedVideo_2eproto_deps,
    1,
    1,
    schemas,
    file_default_instances,
    TableStruct_daischemas_2fCompressedVideo_2eproto::offsets,
    file_level_metadata_daischemas_2fCompressedVideo_2eproto,
    file_level_enum_descriptors_daischemas_2fCompressedVideo_2eproto,
    file_level_service_descriptors_daischemas_2fCompressedVideo_2eproto,
};
...
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_daischemas_2fCompressedVideo_2eproto_getter() {
  return &descriptor_table_daischemas_2fCompressedVideo_2eproto;
}
// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2
static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_daischemas_2fCompressedVideo_2eproto(&descriptor_table_daischemas_2fCompressedVideo_2eproto);
namespace dai {
namespace schemas {
// ===================================================================
...
CompressedVideo::CompressedVideo(::google::protobuf::Arena* arena)
  ...
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:dai.schemas.CompressedVideo)
}
...
CompressedVideo::CompressedVideo(
  ...
  // @@protoc_insertion_point(copy_constructor:dai.schemas.CompressedVideo)
}
inline PROTOBUF_NDEBUG_INLINE CompressedVideo::Impl_::Impl_(
...
CompressedVideo::~CompressedVideo() {
  // @@protoc_insertion_point(destructor:dai.schemas.CompressedVideo)
...
// @@protoc_insertion_point(message_clear_start:dai.schemas.CompressedVideo)
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
...
const ::_pbi::TcParseTable<2, 4, 1, 50, 2> CompressedVideo::_table_ = {
  {
...
::uint8_t* CompressedVideo::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:dai.schemas.CompressedVideo)
  ::uint32_t cached_has_bits = 0;
  (void)cached_has_bits;
  ...
  if (!this->_internal_frame_id().empty()) {
    ...
    ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "dai.schemas.CompressedVideo.frame_id");
  ...
  if (!this->_internal_format().empty()) {
    ...
    ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "dai.schemas.CompressedVideo.format");
  ...
  // @@protoc_insertion_point(serialize_to_array_end:dai.schemas.CompressedVideo)
  return target;
}

::size_t CompressedVideo::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:dai.schemas.CompressedVideo)
  ::size_t total_size = 0;
...
void CompressedVideo::MergeImpl(::google::protobuf::Message& to_msg, const ::google::protobuf::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:dai.schemas.CompressedVideo)
...
// @@protoc_insertion_point(class_specific_copy_from_start:dai.schemas.CompressedVideo)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
::google::protobuf::Metadata CompressedVideo::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_daischemas_2fCompressedVideo_2eproto_getter, &descriptor_table_daischemas_2fCompressedVideo_2eproto_once,
      file_level_metadata_daischemas_2fCompressedVideo_2eproto[0]);
}
