...
static ::_pb::Metadata file_level_metadata_daischemas_2fModelPrimitive_2eproto[1];
static constexpr const ::_pb::EnumDescriptor**
    file_level_enum_descriptors_daischemas_2fModelPrimitive_2eproto = nullptr;
static constexpr const ::_pb::ServiceDescriptor**
    file_level_service_descriptors_daischemas_2fModelPrimitive_2eproto = nullptr;
const ::uint32_t TableStruct_daischemas_2fModelPrimitive_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
    protodesc_cold) = {
    PROTOBUF_FIELD_OFFSET(::dai::schemas::ModelPrimitive, _impl_._has_bits_),
    PROTOBUF_FIELD_OFFSET(::dai::schemas::ModelPrimitive, _internal_metadata_),
    ~0u,  // no _extensions_
    ~0u,  // no _oneof_case_
    ...
    ~0u,  // no _split_
    ~0u,  // no sizeof(Split)
    PROTOBUF_FIELD_OFFSET(::dai::schemas::ModelPrimitive, _impl_.pose_),
    PROTOBUF_FIELD_OFFSET(::dai::schemas::ModelPrimitive, _impl_.scale_),
    PROTOBUF_FIELD_OFFSET(::dai::schemas::ModelPrimitive, _impl_.color_),
    PROTOBUF_FIELD_OFFSET(::dai::schemas::ModelPrimitive, _impl_.override_color_),
    PROTOBUF_FIELD_OFFSET(::dai::schemas::ModelPrimitive, _impl_.url_),
    PROTOBUF_FIELD_OFFSET(::dai::schemas::ModelPrimitive, _impl_.media_type_),
    PROTOBUF_FIELD_OFFSET(::dai::schemas::ModelPrimitive, _impl_.data_),
    0,
    1,
    2,
    ~0u,
...
static const ::_pbi::MigrationSchema
    schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
        {0, 15, -1, sizeof(::dai::schemas::ModelPrimitive)},
};

static const ::_pb::Message* const file_default_instances[] = {
    &::dai::schemas::_ModelPrimitive_default_instance_._instance,
};
const char descriptor_table_protodef_daischemas_2fModelPrimitive_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
    "\n\037daischemas/ModelPrimitive.proto\022\013dai.s"
    "chemas\032\026daischemas/Color.proto\032\025daischem"
    "as/Pose.proto\032\030daischemas/Vector3.proto\""
    "\300\001\n\016ModelPrimitive\022\037\n\004pose\030\001 \001(\0132\021.dai.s"
    "chemas.Pose\022#\n\005scale\030\002 \001(\0132\024.dai.schemas"
    ".Vector3\022!\n\005color\030\003 \001(\0132\022.dai.schemas.Co"
    "lor\022\026\n\016override_color\030\004 \001(\010\022\013\n\003url\030\005 \001(\t"
    "\022\022\n\nmedia_type\030\006 \001(\t\022\014\n\004data\030\007 \001(\014b\006prot"
    "o3"
};
static const ::_pbi::DescriptorTable* const descriptor_table_daischemas_2fModelPrimitive_2eproto_deps[3] =
    {
...
static ::absl::once_flag descriptor_table_daischemas_2fModelPrimitive_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_daischemas_2fModelPrimitive_2eproto = {
    false,
    false,
    322,
    descriptor_table_protodef_daischemas_2fModelPrimitive_2eproto,
    "daischemas/ModelPrimitive.proto",
    &descriptor_table_daischemas_2fModelPrimitive_2eproto_once,
    descriptor_table_daischemas_2fModelPrimitive_2eproto_deps,
    3,
    1,
    schemas,
    file_default_instances,
    TableStruct_daischemas_2fModelPrimitive_2eproto::offsets,
    file_level_metadata_daischemas_2fModelPrimitive_2eproto,
    file_level_enum_descriptors_daischemas_2fModelPrimitive_2eproto,
    file_level_service_descriptors_daischemas_2fModelPrimitive_2eproto,
};
...
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_daischemas_2fModelPrimitive_2eproto_getter() {
  return &descriptor_table_daischemas_2fModelPrimitive_2eproto;
}
// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2
static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_daischemas_2fModelPrimitive_2eproto(&descriptor_table_daischemas_2fModelPrimitive_2eproto);
namespace dai {
namespace schemas {
// ===================================================================
...
class ModelPrimitive::_Internal {
 public:
  ...
  static const ::dai::schemas::Pose& pose(const ModelPrimitive* msg);
  static void set_has_pose(HasBits* has_bits) {
    (*has_bits)[0] |= 1u;
  }
  static const ::dai::schemas::Vector3& scale(const ModelPrimitive* msg);
  static void set_has_scale(HasBits* has_bits) {
    (*has_bits)[0] |= 2u;
  }
  static const ::dai::schemas::Color& color(const ModelPrimitive* msg);
  static void set_has_color(HasBits* has_bits) {
    (*has_bits)[0] |= 4u;
  }
};

const ::dai::schemas::Pose& ModelPrimitive::_Internal::pose(const ModelPrimitive* msg) {
  return *msg->_impl_.pose_;
}
const ::dai::schemas::Vector3& ModelPrimitive::_Internal::scale(const ModelPrimitive* msg) {
  return *msg->_impl_.scale_;
}
const ::dai::schemas::Color& ModelPrimitive::_Internal::color(const ModelPrimitive* msg) {
...
ModelPrimitive::ModelPrimitive(::google::protobuf::Arena* arena)
  ...
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:dai.schemas.ModelPrimitive)
}
...
ModelPrimitive::ModelPrimitive(
  ...
  _impl_.scale_ = (cached_has_bits & 0x00000002u)
                ? CreateMaybeMessage<::dai::schemas::Vector3>(arena, *from._impl_.scale_)
                : nullptr;
  ...
  // @@protoc_insertion_point(copy_constructor:dai.schemas.ModelPrimitive)
}
inline PROTOBUF_NDEBUG_INLINE ModelPrimitive::Impl_::Impl_(
...
ModelPrimitive::~ModelPrimitive() {
  // @@protoc_insertion_point(destructor:dai.schemas.ModelPrimitive)
...
// @@protoc_insertion_point(message_clear_start:dai.schemas.ModelPrimitive)
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
...
const ::_pbi::TcParseTable<3, 7, 3, 48, 2> ModelPrimitive::_table_ = {
  {
...
::uint8_t* ModelPrimitive::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:dai.schemas.ModelPrimitive)
  ::uint32_t cached_has_bits = 0;
  (void)cached_has_bits;
  ...
  if (!this->_internal_url().empty()) {
    ...
    ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "dai.schemas.ModelPrimitive.url");
  ...
  if (!this->_internal_media_type().empty()) {
    ...
    ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "dai.schemas.ModelPrimitive.media_type");
  ...
  // @@protoc_insertion_point(serialize_to_array_end:dai.schemas.ModelPrimitive)
  return target;
}

::size_t ModelPrimitive::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:dai.schemas.ModelPrimitive)
  ::size_t total_size = 0;
...
void ModelPrimitive::MergeImpl(::google::protobuf::Message& to_msg, const ::google::protobuf::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:dai.schemas.ModelPrimitive)
  ...
  if (cached_has_bits & 0x00000007u) {
    ...
    if (cached_has_bits & 0x00000002u) {
      _this->_internal_mutable_scale()->::dai::schemas::Vector3::MergeFrom(
...
// @@protoc_insertion_point(class_specific_copy_from_start:dai.schemas.ModelPrimitive)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
::google::protobuf::Metadata ModelPrimitive::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_daischemas_2fModelPrimitive_2eproto_getter, &descriptor_table_daischemas_2fModelPrimitive_2eproto_once,
      file_level_metadata_daischemas_2fModelPrimitive_2eproto[0]);
}
