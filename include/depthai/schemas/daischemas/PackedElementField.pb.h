...
#ifndef GOOGLE_PROTOBUF_INCLUDED_daischemas_2fPackedElementField_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_daischemas_2fPackedElementField_2eproto_2epb_2eh
...
#define PROTOBUF_INTERNAL_EXPORT_daischemas_2fPackedElementField_2eproto
...
struct TableStruct_daischemas_2fPackedElementField_2eproto {
...
class PackedElementField final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:dai.schemas.PackedElementField) */ {
 public:
  ...
  static ::absl::string_view FullMessageName() {
    return "dai.schemas.PackedElementField";
  }
  protected:
  ...
  void clear_type() ;
  ::dai::schemas::PackedElementField_NumericType type() const;
  void set_type(::dai::schemas::PackedElementField_NumericType value);

  private:
  ::dai::schemas::PackedElementField_NumericType _internal_type() const;
  void _internal_set_type(::dai::schemas::PackedElementField_NumericType value);

  public:
  // @@protoc_insertion_point(class_scope:dai.schemas.PackedElementField)
 private:
  class _Internal;
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_daischemas_2fPackedElementField_2eproto;
};
...
inline const std::string& PackedElementField::name() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:dai.schemas.PackedElementField.name)
...
inline PROTOBUF_ALWAYS_INLINE void PackedElementField::set_name(Arg_&& arg,
  ...
  // @@protoc_insertion_point(field_set:dai.schemas.PackedElementField.name)
}
inline std::string* PackedElementField::mutable_name() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  std::string* _s = _internal_mutable_name();
  // @@protoc_insertion_point(field_mutable:dai.schemas.PackedElementField.name)
  return _s;
}
...
inline std::string* PackedElementField::release_name() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  // @@protoc_insertion_point(field_release:dai.schemas.PackedElementField.name)
...
inline void PackedElementField::set_allocated_name(std::string* value) {
  ...
  // @@protoc_insertion_point(field_set_allocated:dai.schemas.PackedElementField.name)
}
...
inline ::uint32_t PackedElementField::offset() const {
  // @@protoc_insertion_point(field_get:dai.schemas.PackedElementField.offset)
  return _internal_offset();
}
inline void PackedElementField::set_offset(::uint32_t value) {
  _internal_set_offset(value);
  // @@protoc_insertion_point(field_set:dai.schemas.PackedElementField.offset)
}
...
inline ::dai::schemas::PackedElementField_NumericType PackedElementField::type() const {
  // @@protoc_insertion_point(field_get:dai.schemas.PackedElementField.type)
  return _internal_type();
}
inline void PackedElementField::set_type(::dai::schemas::PackedElementField_NumericType value) {
  _internal_set_type(value);
  // @@protoc_insertion_point(field_set:dai.schemas.PackedElementField.type)
}
inline ::dai::schemas::PackedElementField_NumericType PackedElementField::_internal_type() const {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
  return static_cast<::dai::schemas::PackedElementField_NumericType>(_impl_.type_);
}
inline void PackedElementField::_internal_set_type(::dai::schemas::PackedElementField_NumericType value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  ;
  _impl_.type_ = value;
}
...
template <>
struct is_proto_enum<::dai::schemas::PackedElementField_NumericType> : std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor<::dai::schemas::PackedElementField_NumericType>() {
  return ::dai::schemas::PackedElementField_NumericType_descriptor();
}
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_daischemas_2fPackedElementField_2eproto_2epb_2eh
