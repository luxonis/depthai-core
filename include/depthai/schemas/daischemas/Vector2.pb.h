...
#ifndef GOOGLE_PROTOBUF_INCLUDED_daischemas_2fVector2_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_daischemas_2fVector2_2eproto_2epb_2eh
...
#define PROTOBUF_INTERNAL_EXPORT_daischemas_2fVector2_2eproto
...
struct TableStruct_daischemas_2fVector2_2eproto {
...
class Vector2 final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:dai.schemas.Vector2) */ {
 public:
  ...
  public:
  // @@protoc_insertion_point(class_scope:dai.schemas.Vector2)
 private:
  class _Internal;
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_daischemas_2fVector2_2eproto;
};
...
inline double Vector2::x() const {
  // @@protoc_insertion_point(field_get:dai.schemas.Vector2.x)
  return _internal_x();
}
inline void Vector2::set_x(double value) {
  _internal_set_x(value);
  // @@protoc_insertion_point(field_set:dai.schemas.Vector2.x)
}
...
inline double Vector2::y() const {
  // @@protoc_insertion_point(field_get:dai.schemas.Vector2.y)
  return _internal_y();
}
inline void Vector2::set_y(double value) {
  _internal_set_y(value);
  // @@protoc_insertion_point(field_set:dai.schemas.Vector2.y)
}
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_daischemas_2fVector2_2eproto_2epb_2eh
