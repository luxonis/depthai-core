...
#ifndef GOOGLE_PROTOBUF_INCLUDED_daischemas_2fPoint3_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_daischemas_2fPoint3_2eproto_2epb_2eh
...
#define PROTOBUF_INTERNAL_EXPORT_daischemas_2fPoint3_2eproto
...
struct TableStruct_daischemas_2fPoint3_2eproto {
...
class Point3 final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:dai.schemas.Point3) */ {
 public:
  ...
  public:
  // @@protoc_insertion_point(class_scope:dai.schemas.Point3)
 private:
  class _Internal;
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_daischemas_2fPoint3_2eproto;
};
...
inline double Point3::x() const {
  // @@protoc_insertion_point(field_get:dai.schemas.Point3.x)
  return _internal_x();
}
inline void Point3::set_x(double value) {
  _internal_set_x(value);
  // @@protoc_insertion_point(field_set:dai.schemas.Point3.x)
}
...
inline double Point3::y() const {
  // @@protoc_insertion_point(field_get:dai.schemas.Point3.y)
  return _internal_y();
}
inline void Point3::set_y(double value) {
  _internal_set_y(value);
  // @@protoc_insertion_point(field_set:dai.schemas.Point3.y)
}
...
inline double Point3::z() const {
  // @@protoc_insertion_point(field_get:dai.schemas.Point3.z)
  return _internal_z();
}
inline void Point3::set_z(double value) {
  _internal_set_z(value);
  // @@protoc_insertion_point(field_set:dai.schemas.Point3.z)
}
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_daischemas_2fPoint3_2eproto_2epb_2eh
