...
static ::_pb::Metadata file_level_metadata_daischemas_2fGrid_2eproto[1];
static constexpr const ::_pb::EnumDescriptor**
    file_level_enum_descriptors_daischemas_2fGrid_2eproto = nullptr;
static constexpr const ::_pb::ServiceDescriptor**
    file_level_service_descriptors_daischemas_2fGrid_2eproto = nullptr;
const ::uint32_t TableStruct_daischemas_2fGrid_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
    protodesc_cold) = {
    PROTOBUF_FIELD_OFFSET(::dai::schemas::Grid, _impl_._has_bits_),
    PROTOBUF_FIELD_OFFSET(::dai::schemas::Grid, _internal_metadata_),
    ~0u,  // no _extensions_
    ~0u,  // no _oneof_case_
    ...
    ~0u,  // no _split_
    ~0u,  // no sizeof(Split)
    PROTOBUF_FIELD_OFFSET(::dai::schemas::Grid, _impl_.timestamp_),
    PROTOBUF_FIELD_OFFSET(::dai::schemas::Grid, _impl_.frame_id_),
    PROTOBUF_FIELD_OFFSET(::dai::schemas::Grid, _impl_.pose_),
    PROTOBUF_FIELD_OFFSET(::dai::schemas::Grid, _impl_.column_count_),
    PROTOBUF_FIELD_OFFSET(::dai::schemas::Grid, _impl_.cell_size_),
    PROTOBUF_FIELD_OFFSET(::dai::schemas::Grid, _impl_.row_stride_),
    PROTOBUF_FIELD_OFFSET(::dai::schemas::Grid, _impl_.cell_stride_),
    PROTOBUF_FIELD_OFFSET(::dai::schemas::Grid, _impl_.fields_),
    PROTOBUF_FIELD_OFFSET(::dai::schemas::Grid, _impl_.data_),
    0,
    ~0u,
    1,
    ~0u,
...
static const ::_pbi::MigrationSchema
    schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
        {0, 17, -1, sizeof(::dai::schemas::Grid)},
};

static const ::_pb::Message* const file_default_instances[] = {
    &::dai::schemas::_Grid_default_instance_._instance,
};
const char descriptor_table_protodef_daischemas_2fGrid_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
    "\n\025daischemas/Grid.proto\022\013dai.schemas\032#da"
    "ischemas/PackedElementField.proto\032\025daisc"
    "hemas/Pose.proto\032\030daischemas/Vector2.pro"
    ...
    "\001(\0132\021.dai.schemas.Pose\022\024\n\014column_count\030\004"
    " \001(\007\022\'\n\tcell_size\030\005 \001(\0132\024.dai.schemas.Ve"
    "ctor2\022\022\n\nrow_stride\030\006 \001(\007\022\023\n\013cell_stride"
    "\030\007 \001(\007\022/\n\006fields\030\010 \003(\0132\037.dai.schemas.Pac"
    "kedElementField\022\014\n\004data\030\t \001(\014b\006proto3"
};
static const ::_pbi::DescriptorTable* const descriptor_table_daischemas_2fGrid_2eproto_deps[4] =
    {
        &::descriptor_table_daischemas_2fPackedElementField_2eproto,
        &::descriptor_table_daischemas_2fPose_2eproto,
        &::descriptor_table_daischemas_2fVector2_2eproto,
        &::descriptor_table_google_2fprotobuf_2ftimestamp_2eproto,
};
static ::absl::once_flag descriptor_table_daischemas_2fGrid_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_daischemas_2fGrid_2eproto = {
    false,
    false,
    437,
    descriptor_table_protodef_daischemas_2fGrid_2eproto,
    "daischemas/Grid.proto",
    &descriptor_table_daischemas_2fGrid_2eproto_once,
    descriptor_table_daischemas_2fGrid_2eproto_deps,
    4,
    1,
    schemas,
    file_default_instances,
    TableStruct_daischemas_2fGrid_2eproto::offsets,
    file_level_metadata_daischemas_2fGrid_2eproto,
    file_level_enum_descriptors_daischemas_2fGrid_2eproto,
    file_level_service_descriptors_daischemas_2fGrid_2eproto,
};
...
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_daischemas_2fGrid_2eproto_getter() {
  return &descriptor_table_daischemas_2fGrid_2eproto;
}
// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2
static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_daischemas_2fGrid_2eproto(&descriptor_table_daischemas_2fGrid_2eproto);
namespace dai {
namespace schemas {
// ===================================================================
...
class Grid::_Internal {
 public:
  ...
  static const ::dai::schemas::Pose& pose(const Grid* msg);
  static void set_has_pose(HasBits* has_bits) {
    (*has_bits)[0] |= 2u;
  }
  static const ::dai::schemas::Vector2& cell_size(const Grid* msg);
...
const ::dai::schemas::Pose& Grid::_Internal::pose(const Grid* msg) {
  return *msg->_impl_.pose_;
}
const ::dai::schemas::Vector2& Grid::_Internal::cell_size(const Grid* msg) {
...
Grid::Grid(::google::protobuf::Arena* arena)
  ...
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:dai.schemas.Grid)
}
...
Grid::Grid(
  ...
  _impl_.cell_size_ = (cached_has_bits & 0x00000004u)
                ? CreateMaybeMessage<::dai::schemas::Vector2>(arena, *from._impl_.cell_size_)
                : nullptr;
  ...
  // @@protoc_insertion_point(copy_constructor:dai.schemas.Grid)
}
inline PROTOBUF_NDEBUG_INLINE Grid::Impl_::Impl_(
...
Grid::~Grid() {
  // @@protoc_insertion_point(destructor:dai.schemas.Grid)
...
// @@protoc_insertion_point(message_clear_start:dai.schemas.Grid)
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
...
const ::_pbi::TcParseTable<4, 9, 4, 41, 2> Grid::_table_ = {
  {
    ...
    {::_pbi::TcParser::GetTable<::dai::schemas::Vector2>()},
...
::uint8_t* Grid::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:dai.schemas.Grid)
  ::uint32_t cached_has_bits = 0;
  (void)cached_has_bits;
  ...
  if (!this->_internal_frame_id().empty()) {
    ...
    ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "dai.schemas.Grid.frame_id");
  ...
  // @@protoc_insertion_point(serialize_to_array_end:dai.schemas.Grid)
  return target;
}

::size_t Grid::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:dai.schemas.Grid)
  ::size_t total_size = 0;
...
void Grid::MergeImpl(::google::protobuf::Message& to_msg, const ::google::protobuf::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:dai.schemas.Grid)
  ...
  if (cached_has_bits & 0x00000007u) {
    ...
    if (cached_has_bits & 0x00000004u) {
      _this->_internal_mutable_cell_size()->::dai::schemas::Vector2::MergeFrom(
...
// @@protoc_insertion_point(class_specific_copy_from_start:dai.schemas.Grid)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
::google::protobuf::Metadata Grid::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_daischemas_2fGrid_2eproto_getter, &descriptor_table_daischemas_2fGrid_2eproto_once,
      file_level_metadata_daischemas_2fGrid_2eproto[0]);
}
