...
inline constexpr PointsAnnotation::Impl_::Impl_(
    ::_pbi::ConstantInitialized) noexcept
      : _cached_size_{0},
        ...
        fill_color_{nullptr},
        thickness_{0},
        type_{static_cast< ::foxglove::PointsAnnotation_Type >(0)} {}
...
static constexpr const ::_pb::ServiceDescriptor**
    file_level_service_descriptors_foxglove_2fPointsAnnotation_2eproto = nullptr;
const ::uint32_t TableStruct_foxglove_2fPointsAnnotation_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
    protodesc_cold) = {
    PROTOBUF_FIELD_OFFSET(::foxglove::PointsAnnotation, _impl_._has_bits_),
...
static const ::_pbi::MigrationSchema
    schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
        {0, 15, -1, sizeof(::foxglove::PointsAnnotation)},
};
...
static ::absl::once_flag descriptor_table_foxglove_2fPointsAnnotation_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_foxglove_2fPointsAnnotation_2eproto = {
    false,
    false,
    494,
    descriptor_table_protodef_foxglove_2fPointsAnnotation_2eproto,
    "foxglove/PointsAnnotation.proto",
    &descriptor_table_foxglove_2fPointsAnnotation_2eproto_once,
    descriptor_table_foxglove_2fPointsAnnotation_2eproto_deps,
    3,
    1,
    schemas,
    file_default_instances,
    TableStruct_foxglove_2fPointsAnnotation_2eproto::offsets,
    file_level_metadata_foxglove_2fPointsAnnotation_2eproto,
    file_level_enum_descriptors_foxglove_2fPointsAnnotation_2eproto,
...
static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_foxglove_2fPointsAnnotation_2eproto(&descriptor_table_foxglove_2fPointsAnnotation_2eproto);
namespace foxglove {
const ::google::protobuf::EnumDescriptor* PointsAnnotation_Type_descriptor() {
  ::google::protobuf::internal::AssignDescriptors(&descriptor_table_foxglove_2fPointsAnnotation_2eproto);
...
const ::foxglove::Color& PointsAnnotation::_Internal::outline_color(const PointsAnnotation* msg) {
  return *msg->_impl_.outline_color_;
}
const ::foxglove::Color& PointsAnnotation::_Internal::fill_color(const PointsAnnotation* msg) {
