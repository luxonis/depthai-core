...
inline constexpr PackedElementField::Impl_::Impl_(
    ::_pbi::ConstantInitialized) noexcept
      : name_(
        ...
        offset_{0u},
        type_{static_cast< ::foxglove::PackedElementField_NumericType >(0)},
        _cached_size_{0} {}
...
static constexpr const ::_pb::ServiceDescriptor**
    file_level_service_descriptors_foxglove_2fPackedElementField_2eproto = nullptr;
const ::uint32_t TableStruct_foxglove_2fPackedElementField_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
    protodesc_cold) = {
    ~0u,  // no _has_bits_
...
static ::absl::once_flag descriptor_table_foxglove_2fPackedElementField_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_foxglove_2fPackedElementField_2eproto = {
    false,
    false,
    283,
    descriptor_table_protodef_foxglove_2fPackedElementField_2eproto,
    "foxglove/PackedElementField.proto",
    &descriptor_table_foxglove_2fPackedElementField_2eproto_once,
    nullptr,
    0,
    1,
    schemas,
    file_default_instances,
    TableStruct_foxglove_2fPackedElementField_2eproto::offsets,
    file_level_metadata_foxglove_2fPackedElementField_2eproto,
    file_level_enum_descriptors_foxglove_2fPackedElementField_2eproto,
...
static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_foxglove_2fPackedElementField_2eproto(&descriptor_table_foxglove_2fPackedElementField_2eproto);
namespace foxglove {
const ::google::protobuf::EnumDescriptor* PackedElementField_NumericType_descriptor() {
  ::google::protobuf::internal::AssignDescriptors(&descriptor_table_foxglove_2fPackedElementField_2eproto);
...
const ::_pbi::TcParseTable<2, 3, 0, 40, 2> PackedElementField::_table_ = {
  {
    0,  // no _has_bits_
    0, // no _extensions_
...
::uint8_t* PackedElementField::_InternalSerialize(
  ...
  if (!this->_internal_name().empty()) {
    ...
    ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "foxglove.PackedElementField.name");
