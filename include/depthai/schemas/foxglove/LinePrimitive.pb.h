...
#ifndef GOOGLE_PROTOBUF_INCLUDED_foxglove_2fLinePrimitive_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_foxglove_2fLinePrimitive_2eproto_2epb_2eh
...
class LinePrimitive final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:foxglove.LinePrimitive) */ {
 public:
...
inline const ::foxglove::Pose& LinePrimitive::pose() const ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:foxglove.LinePrimitive.pose)
  return _internal_pose();
}
inline void LinePrimitive::unsafe_arena_set_allocated_pose(::foxglove::Pose* value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  if (GetArena() == nullptr) {
...
inline ::foxglove::Pose* LinePrimitive::mutable_pose() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  ::foxglove::Pose* _msg = _internal_mutable_pose();
  // @@protoc_insertion_point(field_mutable:foxglove.LinePrimitive.pose)
  return _msg;
}
inline void LinePrimitive::set_allocated_pose(::foxglove::Pose* value) {
...
inline ::google::protobuf::RepeatedPtrField<::foxglove::Point3>* LinePrimitive::mutable_points()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline ::foxglove::Point3* LinePrimitive::add_points() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  ::foxglove::Point3* _add = _internal_mutable_points()->Add();
  // @@protoc_insertion_point(field_add:foxglove.LinePrimitive.points)
  return _add;
}
inline const ::google::protobuf::RepeatedPtrField<::foxglove::Point3>& LinePrimitive::points() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline const ::foxglove::Color& LinePrimitive::color() const ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:foxglove.LinePrimitive.color)
  return _internal_color();
}
inline void LinePrimitive::unsafe_arena_set_allocated_color(::foxglove::Color* value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  if (GetArena() == nullptr) {
...
inline ::foxglove::Color* LinePrimitive::mutable_color() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  ::foxglove::Color* _msg = _internal_mutable_color();
  // @@protoc_insertion_point(field_mutable:foxglove.LinePrimitive.color)
  return _msg;
}
inline void LinePrimitive::set_allocated_color(::foxglove::Color* value) {
  ::google::protobuf::Arena* message_arena = GetArena();
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  if (message_arena == nullptr) {
    delete reinterpret_cast<::google::protobuf::MessageLite*>(_impl_.color_);
...
inline ::google::protobuf::RepeatedPtrField<::foxglove::Color>* LinePrimitive::mutable_colors()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline ::foxglove::Color* LinePrimitive::add_colors() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  ::foxglove::Color* _add = _internal_mutable_colors()->Add();
  // @@protoc_insertion_point(field_add:foxglove.LinePrimitive.colors)
  return _add;
}
inline const ::google::protobuf::RepeatedPtrField<::foxglove::Color>& LinePrimitive::colors() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
template <>
struct is_proto_enum<::foxglove::LinePrimitive_Type> : std::true_type {};
template <>
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_foxglove_2fLinePrimitive_2eproto_2epb_2eh
