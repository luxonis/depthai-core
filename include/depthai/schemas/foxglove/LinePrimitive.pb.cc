...
inline constexpr LinePrimitive::Impl_::Impl_(
    ::_pbi::ConstantInitialized) noexcept
      : _cached_size_{0},
        ...
        pose_{nullptr},
        color_{nullptr},
        type_{static_cast< ::foxglove::LinePrimitive_Type >(0)},
...
static constexpr const ::_pb::ServiceDescriptor**
    file_level_service_descriptors_foxglove_2fLinePrimitive_2eproto = nullptr;
const ::uint32_t TableStruct_foxglove_2fLinePrimitive_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
    protodesc_cold) = {
    PROTOBUF_FIELD_OFFSET(::foxglove::LinePrimitive, _impl_._has_bits_),
...
static const ::_pbi::MigrationSchema
    schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
        {0, 16, -1, sizeof(::foxglove::LinePrimitive)},
};
...
static ::absl::once_flag descriptor_table_foxglove_2fLinePrimitive_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_foxglove_2fLinePrimitive_2eproto = {
    false,
    false,
    420,
    descriptor_table_protodef_foxglove_2fLinePrimitive_2eproto,
    "foxglove/LinePrimitive.proto",
    &descriptor_table_foxglove_2fLinePrimitive_2eproto_once,
    descriptor_table_foxglove_2fLinePrimitive_2eproto_deps,
    3,
    1,
    schemas,
    file_default_instances,
    TableStruct_foxglove_2fLinePrimitive_2eproto::offsets,
    file_level_metadata_foxglove_2fLinePrimitive_2eproto,
    file_level_enum_descriptors_foxglove_2fLinePrimitive_2eproto,
...
static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_foxglove_2fLinePrimitive_2eproto(&descriptor_table_foxglove_2fLinePrimitive_2eproto);
namespace foxglove {
const ::google::protobuf::EnumDescriptor* LinePrimitive_Type_descriptor() {
  ::google::protobuf::internal::AssignDescriptors(&descriptor_table_foxglove_2fLinePrimitive_2eproto);
...
const ::foxglove::Pose& LinePrimitive::_Internal::pose(const LinePrimitive* msg) {
  return *msg->_impl_.pose_;
}
const ::foxglove::Color& LinePrimitive::_Internal::color(const LinePrimitive* msg) {
