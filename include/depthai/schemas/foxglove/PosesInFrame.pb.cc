...
static constexpr const ::_pb::EnumDescriptor**
    file_level_enum_descriptors_foxglove_2fPosesInFrame_2eproto = nullptr;
static constexpr const ::_pb::ServiceDescriptor**
    file_level_service_descriptors_foxglove_2fPosesInFrame_2eproto = nullptr;
const ::uint32_t TableStruct_foxglove_2fPosesInFrame_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
    protodesc_cold) = {
    PROTOBUF_FIELD_OFFSET(::foxglove::PosesInFrame, _impl_._has_bits_),
...
static const ::_pbi::MigrationSchema
    schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
        {0, 11, -1, sizeof(::foxglove::PosesInFrame)},
};
...
static ::absl::once_flag descriptor_table_foxglove_2fPosesInFrame_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_foxglove_2fPosesInFrame_2eproto = {
    false,
    false,
    213,
    descriptor_table_protodef_foxglove_2fPosesInFrame_2eproto,
    "foxglove/PosesInFrame.proto",
    &descriptor_table_foxglove_2fPosesInFrame_2eproto_once,
    descriptor_table_foxglove_2fPosesInFrame_2eproto_deps,
    2,
    1,
    schemas,
    file_default_instances,
    TableStruct_foxglove_2fPosesInFrame_2eproto::offsets,
    file_level_metadata_foxglove_2fPosesInFrame_2eproto,
    file_level_enum_descriptors_foxglove_2fPosesInFrame_2eproto,
...
static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_foxglove_2fPosesInFrame_2eproto(&descriptor_table_foxglove_2fPosesInFrame_2eproto);
namespace foxglove {
// ===================================================================
...
const ::_pbi::TcParseTable<2, 3, 2, 38, 2> PosesInFrame::_table_ = {
  {
...
::uint8_t* PosesInFrame::_InternalSerialize(
  ...
  if (!this->_internal_frame_id().empty()) {
    ...
    ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "foxglove.PosesInFrame.frame_id");
