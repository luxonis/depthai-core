 ...
 *
 * @param cacheDirectory: Cache directory to remove, default is MODEL_ZOO_DEFAULT_CACHE_DIRECTORY
 */
void removeCacheFolder(const std::string& cacheDirectory = MODEL_ZOO_DEFAULT_CACHE_DIRECTORY);
