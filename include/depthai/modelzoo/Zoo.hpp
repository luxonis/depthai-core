 ...
 * @param cacheDirectory: Cache directory where the cached models are stored, default is "" which checks DEPTHAI_ZOO_CACHE_PATH environment variable and uses
 * that if set, otherwise defaults to MODEL_ZOO_DEFAULT_CACHE_DIRECTORY
