 ...
 */
class PPTextDetectionParserConfig : public Buffer {
   public:
    ...
    PPTextDetectionParserConfig() = default;

    ~PPTextDetectionParserConfig() override;
     ...
     * @param threshold Mask threshold in the range [0, 1]
     */
    ...
    DatatypeEnum getDatatype() const override {
        return DatatypeEnum::PPTextDetectionParserConfig;
    }

    DEPTHAI_SERIALIZE(PPTextDetectionParserConfig, confidenceThreshold, maskThreshold, maxDetections);
};
