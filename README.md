...
To configure and build this minimal setup (optionally selecting an install location with `CMAKE_INSTALL_PREFIX`):

```
cmake --preset minimal -D CMAKE_INSTALL_PREFIX=build/minimal/install
