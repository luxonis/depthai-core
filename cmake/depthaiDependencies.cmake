...
if(NOT CONFIG_MODE OR (CONFIG_MODE AND NOT DEPTHAI_SHARED_LIBS))
    ...
    if(DEPTHAI_ENABLE_CURL OR DEPTHAI_ENABLE_REMOTE_CONNECTION)
...
macro(_depthai_namespace_install_interface_includedir target)
    if(TARGET ${target})
        ...
        if(_depthai_iid)
            string(REPLACE "$<INSTALL_INTERFACE:include>" "$<INSTALL_INTERFACE:${CMAKE_INSTALL_INCLUDEDIR}>" _depthai_iid "${_depthai_iid}")
