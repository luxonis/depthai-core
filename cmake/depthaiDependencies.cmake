if(CONFIG_MODE)
    ...
    list(APPEND CMAKE_PREFIX_PATH "${CMAKE_CURRENT_LIST_DIR}/xtensor/")
    list(APPEND CMAKE_PREFIX_PATH "${CMAKE_CURRENT_LIST_DIR}/xtl/")
    set(_QUIET "QUIET")
else()
...
message("LOOKING FROM ${CMAKE_CURRENT_LIST_DIR}")
