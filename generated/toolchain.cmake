...
if(NOT "/work/vcpkg/scripts/buildsystems/vcpkg.cmake" STREQUAL "")
  ...
  if("" STREQUAL "")
    ...
    if(NOT EXISTS "/work/vcpkg/scripts/buildsystems/vcpkg.cmake")
      message(
          FATAL_ERROR "File not found: '/work/vcpkg/scripts/buildsystems/vcpkg.cmake'"
      )
    endif()
    set(_original_toolchain_file "/work/vcpkg/scripts/buildsystems/vcpkg.cmake")
  else()
