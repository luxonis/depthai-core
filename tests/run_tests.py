...
if __name__ == "__main__":
    ...
    for config in test_configs:
        ...
        print(f"Running tests for configuration: {name}, on platform: {env_vars['DEPTHAI_PLATFORM'] if 'DEPTHAI_PLATFORM' in env_vars else 'null'}, on protocol: {env_vars['DEPTHAI_PROTOCOL'] if 'DEPTHAI_PROTOCOL' in env_vars else 'null'}, with labels: {labels if labels is not None else ""}")
