...
TEST_CASE("DetectionParser replay test") {
    std::filesystem::path YOLO_V6_R2_COCO_512x288_GROUND_TRUTH =
        std::filesystem::path("/home/aljaz/work-luxonis/depthai-core/yolov6-nano:r2-coco-512x288:a26d1ee-detections.json");
    std::filesystem::path YOLO_V6_R2_COCO_512x384_GROUND_TRUTH =
        std::filesystem::path("/home/aljaz/work-luxonis/depthai-core/yolov6-nano:r2-coco-512x384:fb1429e-detections.json");
    std::filesystem::path YOLO_V8_INSTANCE_SEGMENTATION_NANO_COCO_512x288_GROUND_TRUTH =
        std::filesystem::path("/home/aljaz/work-luxonis/depthai-core/yolov8-instance-segmentation-nano:coco-512x288:6c0402a-detections.json");
    std::filesystem::path YOLO_V8_LARGE_POSE_ESTIMATION_COCO_640x352_GROUND_TRUTH =
        std::filesystem::path("/home/aljaz/work-luxonis/depthai-core/yolov8-large-pose-estimation:coco-640x352:1868e39-detections.json");
    std::filesystem::path YOLO_V8_INSTANCE_SEGMENTATION_LARGE_COCO_640x352_GROUND_TRUTH =
        std::filesystem::path("/home/aljaz/work-luxonis/depthai-core/yolov8-instance-segmentation-large:coco-640x352:701031f-detections.json");
    std::filesystem::path YOLO_V10_NANO_COCO_512x288_GROUND_TRUTH =
        std::filesystem::path("/home/aljaz/work-luxonis/depthai-core/yolov10-nano:coco-512x288:007b5fe-detections.json");
    std::filesystem::path PPE_DETECTION_640x640_GROUND_TRUTH =
        std::filesystem::path("/home/aljaz/work-luxonis/depthai-core/ppe-detection:640x640:419a4e5-detections.json");
    std::filesystem::path YOLO_P_BDD100K_320x320_GROUND_TRUTH =
        std::filesystem::path("/home/aljaz/work-luxonis/depthai-core/yolo-p:bdd100k-320x320:7019bb8-detections.json");
    std::filesystem::path FIRE_DETECTION_512x288_GROUND_TRUTH =
        std::filesystem::path("/home/aljaz/work-luxonis/depthai-core/fire-detection:512x288:4a8263c-detections.json");

    std::filesystem::path PEOPLE_WALKING_VIDEO = std::filesystem::path("/home/aljaz/work-luxonis/depthai-core/pedestrians_walking_4k_25fps.mp4");
    std::filesystem::path FIRE_VIDEO = std::filesystem::path("/home/aljaz/work-luxonis/depthai-core/fire_hd_1920_1080_24fps.mp4");

    std::vector<std::tuple<std::string, std::filesystem::path, std::filesystem::path>> testCases = {
        {"yolov6-nano:r2-coco-512x288:a26d1ee", YOLO_V6_R2_COCO_512x288_GROUND_TRUTH, PEOPLE_WALKING_VIDEO},
        {"yolov6-nano:r2-coco-512x384:fb1429e", YOLO_V6_R2_COCO_512x384_GROUND_TRUTH, PEOPLE_WALKING_VIDEO},
        {"yolov8-instance-segmentation-nano:coco-512x288:6c0402a", YOLO_V8_INSTANCE_SEGMENTATION_NANO_COCO_512x288_GROUND_TRUTH, PEOPLE_WALKING_VIDEO},
        {"yolov8-large-pose-estimation:coco-640x352:1868e39", YOLO_V8_LARGE_POSE_ESTIMATION_COCO_640x352_GROUND_TRUTH, PEOPLE_WALKING_VIDEO},
        {"yolov8-instance-segmentation-large:coco-640x352:701031f", YOLO_V8_INSTANCE_SEGMENTATION_LARGE_COCO_640x352_GROUND_TRUTH, PEOPLE_WALKING_VIDEO},
        {"yolov10-nano:coco-512x288:007b5fe", YOLO_V10_NANO_COCO_512x288_GROUND_TRUTH, PEOPLE_WALKING_VIDEO},
        {"ppe-detection:640x640:419a4e5", PPE_DETECTION_640x640_GROUND_TRUTH, PEOPLE_WALKING_VIDEO},
        {"yolo-p:bdd100k-320x320:7019bb8", YOLO_P_BDD100K_320x320_GROUND_TRUTH, PEOPLE_WALKING_VIDEO},
        {"fire-detection:512x288:4a8263c", FIRE_DETECTION_512x288_GROUND_TRUTH, FIRE_VIDEO}};
...
TEST_CASE("DetectionParser segmentationDecode") {
    ...
    std::filesystem::path KITCHEN_IMAGE_PATH = std::filesystem::path("/home/aljaz/work-luxonis/depthai-core/kitchen1.png");
    std::filesystem::path YOLO_V8_INSTANCE_SEGMENTATION_LARGE_COCO_640x352_KITCHEN_SEGMENTATION_GROUND_TRUTH =
        std::filesystem::path("/home/aljaz/work-luxonis/depthai-core/yolov8-instance-segmentation-large:coco-640x352:701031f-segmentation_mask.png");

    const std::string segmentationGroundTruth = YOLO_V8_INSTANCE_SEGMENTATION_LARGE_COCO_640x352_KITCHEN_SEGMENTATION_GROUND_TRUTH.string();
