...
TEST_CASE("Host and Device impl comparison") {
    ...
    manipDeviceGRAY8->setMaxOutputFrameSize(4800000);
    ...
    manipDeviceNV12->setMaxOutputFrameSize(4800000);
    ...
    manipDeviceRGB888i->setMaxOutputFrameSize(4800000);
    ...
    manipDeviceRGB888p->setMaxOutputFrameSize(4800000);
    ...
    manipHost->setMaxOutputFrameSize(4800000);
