...
TEST_CASE("updateBoundingBox includes points with non-positive z", "[PointCloudData][BoundingBox]") {
    dai::PointCloudData pcd;
    ...
    REQUIRE(pcd.getMinX() == Catch::Approx(-100.f));
    REQUIRE(pcd.getMaxX() == Catch::Approx(999.f));
    REQUIRE(pcd.getMinY() == Catch::Approx(-200.f));
    REQUIRE(pcd.getMaxY() == Catch::Approx(999.f));
    REQUIRE(pcd.getMinZ() == Catch::Approx(-1.f));
    REQUIRE(pcd.getMaxZ() == Catch::Approx(4.f));
}

TEST_CASE("updateBoundingBox includes all points regardless of z sign", "[PointCloudData][BoundingBox]") {
    dai::PointCloudData pcd;
    ...
    REQUIRE(pcd.getMinX() == Catch::Approx(-1.f));
    REQUIRE(pcd.getMaxX() == Catch::Approx(1.f));
    REQUIRE(pcd.getMinZ() == Catch::Approx(-5.f));
...
TEST_CASE("PointCloudConfig defaults and setters", "[PointCloudConfig]") {
    ...
    // Default length unit is MILLIMETER
    REQUIRE(cfg.getLengthUnit() == dai::LengthUnit::MILLIMETER);
    ...
    REQUIRE(cfg.getLengthUnit() == dai::LengthUnit::METER);
