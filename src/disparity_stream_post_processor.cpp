...
DisparityStreamPostProcessor::DisparityStreamPostProcessor(bool produce_d_color) : _produce_depth_color(produce_d_color) {}

void DisparityStreamPostProcessor::onNewData(const StreamInfo& data_info, const StreamData& data) {
...
void DisparityStreamPostProcessor::prepareDepthColorAndNotifyObservers(const StreamInfo& data_info, const StreamData& data) {
