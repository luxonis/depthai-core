...
std::shared_ptr<ADatatype> XLinkInHost::readData(XLinkStream& stream) {
...
std::shared_ptr<ADatatype> XLinkInHost::parsePacketizedData(std::shared_ptr<PacketizedData>& packetizedData, XLinkStream& stream) {
    std::cout << "Packeting \n";
...
void XLinkInHost::parseMessageGroup(std::shared_ptr<MessageGroup>& messageGroup, XLinkStream& stream) {
